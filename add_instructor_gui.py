...
def capture_new_instructor(name,hiredate,department,salary,email,password): #function is modified
    C.check()
    ...
    def capture_image():
        ...
        if ret:
            ...
            print(email)
            if encoded is True:
                DB.insert_instructor(ID,name, hiredate , department,salary, email ,password)
