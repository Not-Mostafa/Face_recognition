...
# Run camera, capture image, encode, and mark attendance
def capture_user(course):
    ...
    def capture_image():
        ...
        if ret:
            ...
            func = Image_Encoder.EncodeImage_attendance(frame, course)
            window2.after(500, window2.destroy)
        else:
    ...
    capture_button = tk.Button(window2, text="Capture Image", command=capture_image)
...
ASSETS_PATH = Path(r"C:\Users\mosta\Desktop\build\assets\frame3")  # Ensure this path is correct
...
# Logout
add_button(1223.0, 900.0, "button_5.png", lambda: open_gui("Login_gui.py"))

# Main "Take Attendance" button
